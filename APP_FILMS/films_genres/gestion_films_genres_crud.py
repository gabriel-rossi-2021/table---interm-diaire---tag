...
def edit_genre_film_selected():
    if request.method == "GET":
        try:
            ...
            lst_data_genres_films_non_attribues = [item['id_details_collaborateur'] for item in data_genres_films_non_attribues]
            ...
            lst_data_genres_films_old_attribues = [item['id_details_collaborateur'] for item in data_genres_films_attribues]
            ...
            lst_data_genres_films_non_attribues = [item['sexe'] for item in data_genres_films_non_attribues]
...
def genres_films_afficher_data(valeur_id_film_selected_dict):
    ...
    try:
        ...
        strsql_film_selected = """SELECT id_collaborateur, nom_famille, prenom, GROUP_CONCAT(id_details_collaborateur) as GenresFilms FROM t_collaborateur_details_collaborateur
                                        ...
                                        WHERE id_collaborateur = %(value_id_film_selected)s"""
